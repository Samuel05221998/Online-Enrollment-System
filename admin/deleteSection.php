    ...
    <div id="body-pd">
        ...
        <div class="right-side">
            ...
            <div class="side-container">
                ...
                <h4>&nbsp;</h4>
                <h3>Subject Code : <?= (isset($sectionid)) ? $sectionid : ' '; ?></h3>
                <h3>Subject Title : <?= (isset($sectionname)) ? $sectionname : ' '; ?></h3>
                ...
                <?php if(isset($sectionid)) { ?>
                    ...
                    <input type="hidden" name="sectionid" value="<?= (isset($sectionid)) ? $sectionid : ' '; ?>">
                    <?php } else { ?>
