<?php
    ...
    if(isset($_POST['Delete'])) {
        ...
        $subjecttitle = $_POST['subject_title'];
        $units = $_POST['units'];
    ...
    <div id="body-pd">
        ...
        <div class="right-side">
            ...
            <div class="side-container">
                ...
                <h4>&nbsp;</h4>
                <h3>Subject Code : <?= (isset($subjectcode)) ? $subjectcode : ' '; ?></h3>
                <h3>Subject Title : <?= (isset($subjecttitle)) ? $subjecttitle : ' '; ?></h3>
                <h3>Units : <?= (isset($units)) ? $units : ' '; ?></h3>
                <h3>Program : <?= (isset($coursecode)) ? $coursecode : ' '; ?></h3>
                <h4>&nbsp;</h4>
