<?php
    ...
    $olenrollment->updateCourse($_POST);
    ...
    if(isset($_POST['Edit'])) {
        ...
        $editCourseDesc = $_POST['editcourseDesc'];
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="body-pd">
        ...
        <div class="right-side">
            ...
            <div class="side-container">
                ...
                <input type = "text" name = "updateCourseCode" id="" value="<?= (isset($editCourseCode)) ? $editCourseCode : '';  ?>" autocomplete="off" readonly>
                <h3>Course Description </h3>
                <input type = "text" name = "updateCourseDesc" id="" value="<?= (isset($editCourseDesc)) ? $editCourseDesc : ''; ?>" autocomplete="off">
                <h4>&nbsp;</h4>
                <?php if(isset($editCourseCode)) { ?>
                    <button type="submit" class="btn-update" name="updateCourse">UPDATE</button>
                    <?php } else { ?>
                        <button type="submit" class="btn-update" name="updateCourse" disabled>UPDATE</button>
                        <?php } ?>
                </form>                      
            </div>                        
        </div>
