<?php
    ...
    $olenrollment->deleteCourse($_POST);
    ...
    if(isset($_POST['Delete'])) {
        ...
        $CourseDesc = $_POST['deleteCourseDesc'];
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="body-pd">
        ...
        <div class="right-side">
            ...
            <div class="side-container">
                ...
                <h4>&nbsp;</h4>
                <h3>Course Code : <?= (isset($CourseCode)) ? $CourseCode : ' '; ?></h3>
                <h3>Course Description : <?= (isset($CourseDesc)) ? $CourseDesc : ' '; ?></h3>
                <h4>&nbsp;</h4>
                ...
                <?php if(isset($CourseCode)) { ?>
                    ...
                    <?php } ?>
                        <input type="hidden" name="delCourseCode" value="<?= (isset($CourseCode)) ? $CourseCode : ' '; ?>">
