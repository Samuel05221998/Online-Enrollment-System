<?php
    ...
    $viewunenrollaccounts = $olenrollment->viewUnEnrollAccount($sycode);
    ...
    <div id="body-pd">
        ...
        <div class="right-side">
            ...
            <table class="table">
                ...
                <tbody>
                <?php $i = 0; ?>
                        <?php if(is_array($viewunenrollaccounts) || is_object($viewunenrollaccounts))  {?>
        
                            <?php foreach($viewunenrollaccounts as $row) {?>
