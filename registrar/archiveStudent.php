<?php
    ...
    $students = $olenrollment->getInactiveStudents();
...
function show_confirm()
{
  ...
  if(r == true)
  {
      <?= $olenrollment->restoreStudent($_POST); ?>
     return true;
  } else {
     return false;
  }
                    ...
                    <tbody> 
                        ...
                        <?php foreach($students as $student) {?>
                            ...
                            <tr>
                                ...
                                <td><?= $student['gdn_mobile_no']; ?></td>
                                <td data-label="Option">
                                    <div class="opt_btn">
                                        <form action="" method="POST">
                                            <input type="submit" class="btn-submit" name="Restore" value="RESTORE" onclick="javascript:return confirm('Are you sure to restore this row?');">
